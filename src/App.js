...
document.getElementById("btn1").click();
 ...
 return (
  <>
              ...
              <Link onClick={closeMenu} to="/senopulace#top" className="app-nav">
      ...
      <div id="b4" className="app-flex-item routing">
        ...
        <span className="title-logo">
          ...
          <img src={logo} className="logo"></img>
            ...
            <div id="menu" className="menu">
              <Link to="/senopulace" className="app-nav">
          ...
          <main className="main-view">
            <Routes>
              <Route path="/senopulace" element={<Home srchValue={search} setValue={setSearch} />}></Route>
